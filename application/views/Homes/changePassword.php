  ...
  <div class="col-md-6 mx-auto">
    <div class="card shadow-lg border-left-info mb-3">
      <div class="card-header text-center">
        <h4 class="font-weight-bold " style="color:rgb(0,0,0,0.7);">Ganti Password</h4>
      </div>
      ...
      <div class="card-body">
        <div class="d-grid gap-2 d-md-flex justify-content-md-start mb-3">
          <a href="<?= site_url('Home/index'); ?>" class="btn btn-outline-dark">
        ...
        <div class=" mb-3">
          ...
          <small class="form-text text-danger"><?= form_error('confirmPassword'); ?></small>
        </div>
